    ...
    <div className="min-h-screen bg-page">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-16">
            ...
            <div className="space-y-6">
              {competitions.map((comp) => (
                <div key={comp.id} className="bg-white rounded-xl border border-gray-100 p-6">
                  ...
                  {/* Location map for location competitions */}
        ...
        <section className="text-center pb-8">
          <p className="text-gray-500 mb-4">Ready to join?</p>
          <Link
            href="/login"
            className="inline-block px-6 py-3 bg-[#185FA5] text-white rounded-lg font-medium text-sm hover:bg-[#145088] transition-colors"
          >
            Sign in to pacepact
          </Link>
        </section>
